...
const curatedQuestions: Question[] = [
  { id:"fentanyl-dose", chapter:"20", category:"Medication review", prompt:"What is the exam dose range for fentanyl?", options:["50-100 mcg","1-5 mg","0.4-2 mg","30 mg IV or 60 mg IM"], answer:"50-100 mcg", hint:"Compare the units before comparing the numbers.", explanation:"Fentanyl is given at 50-100 mcg by IV, IO, IM, SQ, or IN routes for this exam." },
  { id:"versed-profile", chapter:"20", category:"Medication review", prompt:"Which generic name and classification belong to Versed?", options:["Midazolam - benzodiazepine","Etomidate - opioid antagonist","Ketamine - NSAID","Naloxone - anesthetic"], answer:"Midazolam - benzodiazepine", hint:"Work from the medication's drug class, then identify the matching generic name.", explanation:"Versed is the brand name for midazolam, a benzodiazepine used for anxiety, sedation, and seizures." },
  { id:"versed-dose", chapter:"20", category:"Medication review", prompt:"What is the exam dose range for midazolam (Versed)?", options:["1-5 mg","50-100 mcg","0.1-0.3 mg/kg","10-20 mg"], answer:"1-5 mg", hint:"First rule out options using a different unit or dosing style.", explanation:"Midazolam is given at 1-5 mg by IV, IM, or IO routes for this exam." },
  { id:"ketamine-dose", chapter:"20", category:"Medication review", prompt:"Which dose set is correct for ketamine?", options:["0.5-1 mg/kg IV; 2-4 mg/kg IM","0.1-0.3 mg/kg IV only","1-5 mg IV, IM, or IO","30 mg IV; 60 mg IM"], answer:"0.5-1 mg/kg IV; 2-4 mg/kg IM", hint:"Compare the route-specific, weight-based options carefully.", explanation:"Ketamine is given at 0.5-1 mg/kg IV or 2-4 mg/kg IM, with an RSI dose of 1-2 mg/kg IV for this exam." },
  { id:"ketamine-action", chapter:"20", category:"Medication review", prompt:"Ketamine produces dissociation between which systems?", options:["Cortical and limbic systems","Sympathetic and parasympathetic ganglia","Coagulation and fibrinolytic systems","Maternal and fetal circulations"], answer:"Cortical and limbic systems", hint:"Start with the defining feature of a dissociative anesthetic.", explanation:"Ketamine is a dissociative anesthetic that separates cortical and limbic system activity." },
  { id:"narcan-goal", chapter:"20", category:"Medication review", prompt:"What is the immediate treatment goal when naloxone is given for opioid overdose?", options:["Reverse respiratory depression while limiting abrupt withdrawal","Produce complete analgesia","Induce deep sedation","Increase platelet aggregation"], answer:"Reverse respiratory depression while limiting abrupt withdrawal", hint:"Prioritize the most immediate life threat of opioid toxicity.", explanation:"Naloxone should restore adequate ventilation; excessive reversal can precipitate acute opioid withdrawal." },
  { id:"narcan-dose", chapter:"20", category:"Medication review", prompt:"What is the exam dose range for naloxone?", options:["0.4-2 mg","1-5 mg","25-75 mcg/kg/min","160-325 mg"], answer:"0.4-2 mg", hint:"Compare both the unit and the route pattern for each choice.", explanation:"Naloxone is given at 0.4-2 mg by IV, IO, SQ, IN, or nebulized routes for this exam." },
  { id:"etomidate-analgesia", chapter:"20", category:"Medication review", prompt:"What effect does etomidate have on pain?", options:["It provides no analgesia","It reverses opioid analgesia","It produces strong opioid analgesia","It reduces pain by inhibiting thromboxane A2"], answer:"It provides no analgesia", hint:"Separate the concepts of sedation and pain control.", explanation:"Etomidate is a sedative-hypnotic that does not provide analgesia." },
  { id:"etomidate-dose", chapter:"20", category:"Medication review", prompt:"What is the exam dose and route for etomidate?", options:["0.1-0.3 mg/kg IV","2-4 mg/kg IM","50-100 mcg IN","10-20 mg SQ"], answer:"0.1-0.3 mg/kg IV", hint:"Look for an induction-style dose with its matching route.", explanation:"Etomidate is given at 0.1-0.3 mg/kg by the IV route for this exam." },
  { id:"toradol", chapter:"20", category:"Medication review", prompt:"Which class and dose pairing is correct for Toradol?", options:["Ketorolac, NSAID: 30 mg IV or 60 mg IM","Midazolam, benzodiazepine: 30 mg IV","Naloxone, antagonist: 60 mg IM","Fentanyl, opioid: 30 mg IV"], answer:"Ketorolac, NSAID: 30 mg IV or 60 mg IM", hint:"Begin by identifying whether the medication is opioid, sedative, antagonist, or anti-inflammatory.", explanation:"Toradol is ketorolac, an NSAID given at 30 mg IV or 60 mg IM for this exam." },
  { id:"fentanyl-adverse", chapter:"20", category:"Medication review", prompt:"Which adverse effect is especially associated with fentanyl?", options:["Chest-wall rigidity","Myoclonic jerks","Acute opioid withdrawal","GI bleeding"], answer:"Chest-wall rigidity", hint:"Consider which choice is most characteristic of a potent opioid complication.", explanation:"Fentanyl can cause chest-wall rigidity and respiratory depression." },
  { id:"routes-enteral", chapter:"20", category:"Medication routes", prompt:"Which route is enteral?", options:["Oral","Intravenous","Intramuscular","Intraosseous"], answer:"Oral", hint:"Sort the choices by whether they use the digestive system.", explanation:"Oral and rectal routes are enteral; IV, IM, and IO routes are parenteral." },
  { id:"routes-firstpass", chapter:"20", category:"Medication routes", prompt:"Which route is most directly affected by hepatic first-pass metabolism?", options:["Oral","Intravenous","Intraosseous","Intranasal"], answer:"Oral", hint:"Trace the route a drug takes after absorption before it reaches systemic circulation.", explanation:"Oral drugs may be metabolized in the gut wall and liver before reaching systemic circulation." },
  { id:"stats-anova", chapter:"5", category:"Statistics", prompt:"A researcher wants to compare mean response times across four EMS systems. Which test best fits?", options:["ANOVA","Chi square test","Odds ratio","Mode"], answer:"ANOVA", hint:"Classify the outcome first, then count how many group averages are being compared.", explanation:"Analysis of variance compares means across three or more groups." },
  { id:"stats-chi", chapter:"5", category:"Statistics", prompt:"Which test evaluates association between two categorical variables?", options:["Chi square test","t test","ANOVA","Standard deviation"], answer:"Chi square test", hint:"Decide whether the variables are measurements or categories before choosing a test.", explanation:"A chi square test compares observed and expected frequencies for categorical variables." },
  { id:"validity-internal", chapter:"5", category:"Study design", prompt:"A tightly controlled study supports a causal conclusion but may not generalize to rural EMS. Which validity is strong?", options:["Internal validity","External validity","Sampling error","Open access"], answer:"Internal validity", hint:"Separate confidence in the study's cause-and-effect claim from its usefulness elsewhere.", explanation:"Internal validity concerns causal trustworthiness within the study; external validity concerns generalizability." },
  { id:"study-rct", chapter:"5", category:"Study design", prompt:"Which design randomly assigns participants to treatment and control groups?", options:["Randomized controlled trial","Cohort study","Case series","Cross-sectional study"], answer:"Randomized controlled trial", hint:"Focus on how the comparison groups are formed.", explanation:"An RCT is an experiment that uses random assignment to intervention and control conditions." },
  { id:"study-retro", chapter:"5", category:"Study design", prompt:"Investigators review existing patient records to compare past exposures and outcomes. What design is this?", options:["Retrospective study","Prospective study","In vitro study","Randomized controlled trial"], answer:"Retrospective study", hint:"Place the data collection in time before choosing the study design.", explanation:"Retrospective studies look backward using existing data, records, exposures, or outcomes." },
  { id:"ems-online", chapter:"2", category:"Medical oversight", prompt:"A paramedic calls an authorized physician for a real-time medication order. This is what type of direction?", options:["On-line medical direction","Off-line medical oversight","Retrospective oversight","Peer review"], answer:"On-line medical direction", hint:"Think about when the physician's direction is received.", explanation:"On-line medical direction is real-time consultation or ordering; standing protocols are off-line direction." },
  { id:"ems-moi", chapter:"3", category:"Assessment", prompt:"The forces and events that produced a traumatic injury are called the:", options:["Mechanism of injury","Nature of illness","Pathophysiology","Scope of practice"], answer:"Mechanism of injury", hint:"First decide whether the question is asking about trauma, illness, or a professional limit.", explanation:"Mechanism of injury describes how traumatic energy was transferred and injury occurred." },
  { id:"safety-levels", chapter:"4", category:"Infection control", prompt:"Which process destroys all microbial life, including bacterial spores?", options:["Sterilization","Disinfection","Cleaning","Standard Precautions"], answer:"Sterilization", hint:"Order the choices from removing surface soil to eliminating all organisms.", explanation:"Cleaning removes soil, disinfection destroys many pathogens, and sterilization destroys all microbial life including spores." },
  { id:"ambulance-type2", chapter:"1", category:"Ambulance types", prompt:"Which ambulance configuration is built on a van body with an integrated patient compartment?", options:["Type II","Type I","Type III","Helicopter air ambulance"], answer:"Type II", hint:"Compare whether the patient compartment is integrated with the cab or built as a separate module.", explanation:"A Type II ambulance is van-based; Types I and III use modular patient compartments." },
];

const stableHash = (value: string) => [...value].reduce((n, ch) => ((n << 5) - n + ch.charCodeAt(0)) | 0, 0);

const termsIn = (terms: string[]) => new Set(terms.map((term) => term.toLowerCase()));

const transportTerms = termsIn(["active transport", "passive transport", "diffusion", "facilitated diffusion", "carrier-mediated diffusion", "filtration", "osmosis"]);
const receptorTerms = termsIn(["affinity", "agonist", "agonist-antagonist", "antagonist", "partial agonist", "competitive antagonism", "noncompetitive antagonism", "irreversible antagonism", "receptor", "second messenger", "up-regulation", "down-regulation"]);
const drugCourseTerms = termsIn(["bioavailability", "bioequivalence", "biologic half-life", "biotransformation", "first-pass effect", "medications metabolism", "onset of action", "medication duration of action", "termination of action", "plasma-level profile", "minimum effective concentration", "medication-response relationship", "therapeutic index", "prodrug"]);
const studyDesignTerms = termsIn(["case report", "case series", "cohort study", "cross-sectional study", "experimental study", "experiment", "mixed research", "nonrandomized controlled trial", "observational study", "prospective study", "quasiexperimental study", "randomized controlled trial (RCT)", "retrospective study", "single blind study", "double blind study"]);
const samplingTerms = termsIn(["convenience sampling", "random sampling", "systematic sampling", "time sampling", "sampling error", "population", "parameter"]);
const statisticsTerms = termsIn(["analysis of variance (ANOVA)", "chi square test", "confidence interval", "descriptive statistics", "inferential statistics", "mean", "measures of central tendency", "median", "mode", "odds ratio", "P value", "standard deviation (SD or σ)", "statistics", "t test", "variance"]);

const termHint = (item: StudyTerm) => {
  const term = item.term.toLowerCase();

  if (transportTerms.has(term)) return "Picture particles on opposite sides of a membrane. Decide whether the clue is energy, a carrier, pressure, water, or movement down a gradient.";
  if (receptorTerms.has(term)) return "Treat the receptor like a switch. Is the molecule turning it on, blocking it, competing for it, or changing how many switches are available?";
  if (drugCourseTerms.has(term)) return "Follow the drug from administration to effect. The key is whether the definition is about reaching blood, being changed, how long it lasts, or how concentration relates to effect.";

  if (item.chapter === "20") {
    if (term.includes("sympath") || term === "adrenergic" || term === "cholinergic" || term.includes("parasympath")) return "Use the autonomic nervous system as the organizer: ask whether the term mimics, blocks, or describes sympathetic versus parasympathetic signaling.";
    if (term.startsWith("anti") || ["diuretic", "laxative", "mucolytic", "expectorant"].includes(term)) return "The medication class is built around the problem it acts on. Identify the body process being reduced, prevented, or helped before choosing a term.";
    if (["analgesia", "analgesic", "anesthesia", "anesthetic", "hypnosis", "sedation", "neuroleptanesthesia", "neuroleptic"].includes(term)) return "Separate pain relief, loss of sensation, and reduced consciousness. The definition is asking for the clinical effect, not merely a drug name.";
    if (["enteral route", "parenteral route", "oral", "blood-brain barrier", "placental barrier"].includes(term)) return "Trace the physical route or barrier involved. Decide whether the clue concerns the digestive tract, an injection route, or a selective boundary between compartments.";
    if (["preganglionic nerves", "postganglionic nerves", "autonomic ganglia", "autonomic nervous system", "neuroeffector junction", "synapse", "neuron", "neurotransmitter"].includes(term)) return "Map the signal pathway in order: central source, ganglion, target organ. Look for whether the term names a cell, chemical messenger, connection, or part of the pathway.";
    if (["assay", "bioassay", "dose packaging", "drug", "medication", "pharmacology", "pharmacodynamics", "pharmacokinetics", "prototype"].includes(term)) return "Decide whether the definition is asking about measuring a substance, preparing it, or studying what a drug does versus what the body does to it.";
    return "Look for the one clinical process in the definition—such as clotting, immunity, pain, acid, or fluid balance—and rule out terms from unrelated body systems.";
  }

  if (studyDesignTerms.has(term)) return "Build a quick timeline: were people assigned an intervention, simply observed, described after the fact, or followed forward? Then check who knew the group assignment.";
  if (samplingTerms.has(term)) return "Ask whether this is about who the study wants to describe, how people are selected, or the normal gap between a sample and the larger group.";
  if (statisticsTerms.has(term)) return "First sort the definition into a job: center, spread, probability, comparison of groups, association, or estimating a bigger population from a sample.";

  if (item.chapter === "5") {
    if (["bias", "internal validity", "external validity", "validity", "null hypothesis", "hypothesis", "post hoc", "data dredging", "data mining"].includes(term)) return "Ask whether the statement concerns a planned claim, a distorted result, trust in a cause-and-effect conclusion, or whether a result should apply beyond the study.";
    if (["institutional review board (IRB)", "principal investigator (PI)", "peer review", "open access journals", "PubMed", "National EMS Research Agenda"].includes(term)) return "This is about the research process around a study, rather than the study design itself. Identify whether the role is ethics protection, responsibility, publication review, access, search, or priority-setting.";
    if (["nominal data", "ordinal data", "qualitative research", "quantitative research", "qualitative statistics", "quantitative statistics"].includes(term)) return "Separate labels and rankings from numerical measurements. Then decide whether the work is exploring meaning or measuring quantities.";
    return "Decide whether the definition describes a question, a comparison group, a patient outcome, or a method for summarizing evidence.";
  }

  if (item.chapter === "4") {
    if (["cleaning", "disinfection", "sterilization", "Standard Precautions", "personal protective equipment (PPE)", "exposure", "pathogen", "infectious disease", "incubation period"].includes(term)) return "Think along the infection-control chain: organism, contact, time before symptoms, barrier protection, or how completely equipment is decontaminated.";
    if (["burnout", "compassion fatigue", "moral injury", "post-traumatic stress disorder (PTSD)", "resilience", "stress", "stressor", "sleep hygiene", "work-life balance", "peer support", "employee assistance program (EAP)"].includes(term)) return "Decide whether the clue names a source of strain, a stress response, a specific impact of repeated trauma, or a resource that helps recovery.";
    return "Use the body-mechanics clue: is the muscle holding tension without motion, or moving through a range?";
  }

  if (item.chapter === "3") return "Decide whether the definition describes the cause of trauma, the type of illness, a provider role, a body change from disease, or ongoing first-contact care.";
  if (item.chapter === "2") {
    if (["on-line medical direction", "off-line medical oversight", "prospective medical oversight", "retrospective medical oversight", "standing orders", "medical director", "intervener physician"].includes(term)) return "Put the medical direction on a timeline: before the call, during live patient care, or after the chart is reviewed.";
    if (["accreditation", "certification", "licensure", "registration", "reciprocity", "scope of practice"].includes(term)) return "Separate education standards, proof of competence, legal permission to practice, a registry listing, and recognition across jurisdictions.";
    return "Ask whether the definition names a system role, an agency, a communication process, or a professional/legal responsibility.";
  }

  return "Compare the ambulance body and cab arrangement. The key distinction is whether the patient compartment is integrated with the van or built as a separate module.";
};
...
const drugQuestions: Question[] = drugCards.flatMap((drug, index) => {
  ...
  return [{
    ...
    answer: drug.brand,
    hint: "Recall the generic/brand pairing, then eliminate options from unrelated medication classes.",
